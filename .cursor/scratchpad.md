...
- [🔄] Создание компонентной архитектуры (в процессе)
...
**Текущая задача:** Создание компонентной архитектуры (3.3)
...
**Что делаю:** Создаю компонентную архитектуру и базовые UI компоненты
