...
<script type="application/ld+json">
{
  ...
  "description": "Отзыв пользователя о Microsoft Copilot. Реальный опыт использования, плюсы и минусы.",
  "reviewBody": "Личный опыт использования Microsoft Copilot. Подробный анализ возможностей, интерфейса и практического применения.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://aibotsnews.ru/reviews/microsoft-copilot-user-review-2025"
  },
  "image": {
    "@type": "ImageObject",
    "url": "https://aibotsnews.ru/og-image-microsoft-copilot-user-review-2025.png",
    "width": 1200,
    "height": 630
  },
  "reviewRating": {
