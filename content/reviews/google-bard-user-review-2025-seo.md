...
<script type="application/ld+json">
{
  ...
  "description": "Отзыв пользователя о Отзыв о Google Bard 2025: Мнение исследователя. Реальный опыт использования, плюсы и минусы.",
  "reviewBody": "Личный опыт использования Отзыв о Google Bard 2025: Мнение исследователя. Подробный анализ возможностей, интерфейса и практического применения.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://aibotsnews.ru/reviews/google-bard-user-review-2025-seo"
  },
  "image": {
    "@type": "ImageObject",
    "url": "https://aibotsnews.ru/og-image-google-bard-user-review-2025-seo.png",
    "width": 1200,
    "height": 630
  },
  "reviewRating": {
