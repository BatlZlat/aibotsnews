...
<script type="application/ld+json">
{
  ...
  "reviewBody": "Мой опыт использования ChatGPT в 2025 году: честный отзыв представляет собой современный ИИ-инструмент, который заслуживает внимания пользователей. В этом обзоре мы детально рассмотрим его возможности, преимущества и недостатки.",
  "author": {
    "@type": "Organization",
    "name": "ИИ Боты"
  },
