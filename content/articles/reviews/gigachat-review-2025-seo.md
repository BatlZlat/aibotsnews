...
<script type="application/ld+json">
{
  ...
  "reviewBody": "GigaChat: Обзор российского ИИ от Сбера в 2025 году представляет собой современный ИИ-инструмент, который заслуживает внимания пользователей. В этом обзоре мы детально рассмотрим его возможности, преимущества и недостатки.",
  "author": {
    "@type": "Organization",
    "name": "ИИ Боты"
  },
  ...
  "itemReviewed": {
    ...
    "name": "GigaChat",
    "description": "ИИ-инструмент GigaChat",
