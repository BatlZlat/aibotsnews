...
export default function ComparisonsPage() {
  ...
  // Формируем structured data для всех сравнений
  const items = comparisons.map(comparison => generateArticleStructuredData({
    title: comparison.title,
    excerpt: comparison.description,
    featuredImage: '',
    author: 'ИИ Боты',
